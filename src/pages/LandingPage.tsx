...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <section ref={heroRef} className="min-h-screen flex items-center justify-center px-4 md:px-8 pt-20 pb-8 relative overflow-hidden bg-gradient-to-br from-white via-warm-gray-50 to-light-mint/10" aria-label="Hero section">
        <motion.div 
          style={{ opacity, scale }}
